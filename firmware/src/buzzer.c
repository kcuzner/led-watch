...
static void buzzer_set_frequency(void)
{
    ...
    TIM22->ARR = SystemCoreClock / 1000;
    TIM22->CCR1 = SystemCoreClock / 42000;
}
...
void buzzer_init(void)
{
    ...
    //Subscribe to oscillator changes
    osc_add_callback(&buzzer_set_frequency);
